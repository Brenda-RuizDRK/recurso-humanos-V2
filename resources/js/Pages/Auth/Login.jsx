...
=======
                            ...
                            >
                                <path
                                    fill="#F2B705"
                                    d="M12 2a10 10 0 100 20 10 10 0 000-20zm1 17.93V20a8 8 0 01-8-8h2.07A6 6 0 0013 18.93zM4.07 13H2a8 8 0 018-8v2.07A6 6 0 004.07 13zm7.93-7.93V4a8 8 0 018 8h-2.07A6 6 0 0012 4.07zm7.93 7.93h2a8 8 0 01-8 8v-2.07A6 6 0 0020.93 12z"
                                />
                            </svg>
                            Portal Corporativo
>>>>>>> b74f2a53a3cd5a9cfc6ef4429188fa92c620d926
                        </h1>
                        <div className="h-1 w-20 bg-[#F2B705] mb-8 rounded"></div>
                        <p className="text-lg text-blue-100 leading-relaxed max-w-md">
                            Plataforma institucional para la gestión segura de
                            procesos, información estratégica y herramientas
                            internas.
                        </p>
                    </div>
                    <p className="text-sm text-blue-200 mt-8">
                        © {new Date().getFullYear()} Vitracoat · Uso interno
                        exclusivo
                    </p>
                </div>
                                    ...
                                    <div className="relative">
                                        <span className="absolute left-3 top-2.5 text-gray-400">
                                            ...
                                            >
                                                <path
                                                    fill="#1F2E63"
                                                    d="M12 4a7 7 0 00-7 7v3a2 2 0 002 2h1v-2a3 3 0 016 0v2h1a2 2 0 002-2v-3a7 7 0 00-7-7zm1 10v2h-2v-2a1 1 0 012 0z"
                                                />
                                            </svg>
                                        </span>
                                        <input
